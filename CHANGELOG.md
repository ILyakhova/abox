...
| 2026-09-24 | Cluster rebuild, LAB5 restored, LAB8 — agentevals, six scored cases, the roadmap | 630,254 ¹ |
| | **Cumulative** | **~1,311,000** |

¹ Counted from the session transcript: new input (uncached plus cache writes) and output
over 248 model calls — 428,099 in, 202,155 out; cache reads (63.2M) are not included.
The earlier rows were not counted this way and are not directly comparable with this
one. The day was unusually expensive for a
